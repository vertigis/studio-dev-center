...
The VertiGIS Studio Mobile SDK Samples project has a sample of [implementing a command with a custom service](https://github.com/geocortex/vertigis-mobile-samples/tree/master/Geocortex.Mobile.Samples/Geocortex.Mobile.Samples/Samples/Custom/Service).
