...
Strings in custom components are internationalized using references to language resources. Check out the [.NET MAUI Guide to localizing text](https://learn.microsoft.com/en-us/dotnet/maui/fundamentals/localization?view=net-maui-9.0#localize-text).
