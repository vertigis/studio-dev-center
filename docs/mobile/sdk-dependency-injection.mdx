...
Used for registering a [view](https://learn.microsoft.com/en-us/previous-versions/xamarin/xamarin-forms/enterprise-application-patterns/mvvm#view) with VertiGIS Studio Mobile. For a more detailed example see the tutorial on [implementing a custom component with UI](tutorial-implement-component-with-ui.mdx#use-xaml-to-define-your-ui).
...
Used for registering a [view model](https://learn.microsoft.com/en-us/previous-versions/xamarin/xamarin-forms/enterprise-application-patterns/mvvm#viewmodel) with VertiGIS Studio Mobile. For a more detailed example see the tutorial on [implementing a custom component with UI](tutorial-implement-component-with-ui.mdx#example-progress-bar).
...
Check out the VertiGIS Studio Mobile SDK Sample for [dependency injection](https://github.com/vertigis/vertigis-mobile-samples/tree/master/Geocortex.Mobile.Samples/Geocortex.Mobile.Samples/Samples/Conceptual/DependencyInjection).
