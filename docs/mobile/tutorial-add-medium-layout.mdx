...
The VertiGIS Studio Mobile [Quickstart](https://github.com/vertigis/vertigis-mobile-quickstart) comes with a [small and large layout](configuration-layout-getting-started.mdx#device-form-factors). This tutorial will walk you through creating a medium form factor layout.
