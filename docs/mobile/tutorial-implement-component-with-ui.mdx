...
[XAML is a markup language created by Microsoft](https://learn.microsoft.com/en-us/dotnet/maui/xaml/), and one of the recommended patterns for defining UI in Xamarin Forms. We can modify our component to reference a XAML View.
...
:::info
VertiGIS Studio Mobile comes with built-in [Enhanced Components](https://github.com/vertigis/vertigis-mobile-samples/tree/master/Geocortex.Mobile.Samples/Geocortex.Mobile.Samples/Samples/Custom/GeocortexMobileElements) that can ease development and styling of custom UI.
:::
...
-   [Custom Component with XAML](https://github.com/vertigis/vertigis-mobile-samples/tree/master/Geocortex.Mobile.Samples/Geocortex.Mobile.Samples/Samples/Custom/XamlComponent)
