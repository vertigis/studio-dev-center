...
[**VertiGIS Studio Workflow**](https://docs.geocortex.com/workflow/) is a powerful tool that comes bundled with VertiGIS Studio Web which can create custom behavior and UI without custom code development. Many behaviors in VertiGIS Studio Web can be [replaced by a workflow](tutorial-change-default-map-click-behavior.mdx) that runs entirely custom logic. VertiGIS Studio Workflow can even [display complex customized forms](https://docs.geocortex.com/workflow/latest/help/Default.htm#wf5/help/forms.htm).
