...
Some platforms have UI, like VertiGIS Studio Web or VertiGIS Studio Mobile, and can use forms to facilitate end user interaction. VertiGIS Studio Workflow [provides over twenty configurable **form elements**](https://docs.vertigisstudio.com/workflow/latest/help/form-element-reference.html) for building forms, like the Auto Complete, Geometry Picker, Date Picker, Number Slider, and Text Area elements. Just as activities are the building blocks of workflows, form elements are the building blocks of forms.
...
-   ArcGIS Experience Builder (client)
-   ArcGIS Web AppBuilder (client)
-   Geocortex Viewer for HTML5 (client)

**.NET Applications**

-   VertiGIS Studio Mobile (client)
-   VertiGIS Studio Desktop for ArcGIS Pro (client)
-   VertiGIS Studio Workflow Server (server)

[Learn more about the different workflow hosts](https://docs.vertigisstudio.com/workflow/latest/help/hosting.html) or about [adapting workflows to different environments](https://docs.vertigisstudio.com/workflow/latest/help/run-in-different-environments.html).
