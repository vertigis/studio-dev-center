...
:::info Important
.NET Standard projects **must** target .NET Standard 2.1, and .NET projects must target .NET 8.0, or else the assembly will be incompatible with VertiGIS Studio Workflow Server.
:::
