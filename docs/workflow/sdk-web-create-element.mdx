...
Custom form elements can be used in a form through the special [_Custom_](https://docs.vertigisstudio.com/workflow/latest/help/custom.html) form element. This form element displays custom form elements by referencing them by the `id` they were registered with. Enter your element's `id` in the _Custom Type_ input.
...
Now you can [build a workflow](https://docs.vertigisstudio.com/workflow/latest/help/get-started.html) that uses your new custom form element!
