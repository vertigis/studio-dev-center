...
For applications like [Geocortex Viewer for HTML5](https://docs.vertigisstudio.com/essentials/gvh/) or [Web AppBuilder for ArcGIS](https://www.esri.com/en-us/arcgis/products/web-appbuilder/overview) (2D) that use the 3.x ArcGIS API for JavaScript use:
...
```ts
import type { IActivityHandler } from "@vertigis/workflow/runtime/IActivityHandler";
// highlight-start
import * as Extent from "esri/geometry/Extent";
