...
1. Upgrade the packages.
    ...
    1. Run `npm install -D @vertigis/workflow@5.33.0 @vertigis/workflow-sdk@4.0.0`.
...
1. Upgrade the packages.
    1. Open a command prompt and go to the root directory of your activity pack.
    1. Run `npm uninstall @geocortex/workflow`.
    1. Run `npm install -D @vertigis/workflow@5.31.0 @vertigis/workflow-sdk@3.0.0`.
1. Update existing code.
