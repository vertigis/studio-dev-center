...
If you're migrating from v1 or v2 of the SDK to v3, you will need to perform the following changes:

1. Run `npm update`.
1. Find and replace all instances of `@geocortex/workflow` with `@vertigis/workflow`.
