...
import type { CustomFormElementProps } from "@vertigis/workflow/runtime/app/RegisterCustomFormElementBase";
import { RegisterCustomFormElementBase } from "@vertigis/workflow/runtime/app/RegisterCustomFormElementBase";
